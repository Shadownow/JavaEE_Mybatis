...
import org.example.spring.mvc.dao.HomeworkJdbc;
import org.example.spring.mvc.dao.StudentHomeworkJdbc;
import org.example.spring.mvc.dao.StudentJdbc;
...
//    private ApplicationContext context = new FileSystemXmlApplicationContext("/JavaEE_01/src/main/webapp/WEB-INF/applicationContext.xml");
    ...
    public String UpFinishedHomeworkServlet() {
        ...
        StudentJdbc StudentJdbc = (org.example.spring.mvc.dao.StudentJdbc) context.getBean("StudentJdbc");
    ...
    public String UpHomeworkAfterChoseName(@RequestBody String dataString) throws UnsupportedEncodingException {
        ...
        //System.out.println(studentId);
        HomeworkJdbc HomeworkJdbc = (org.example.spring.mvc.dao.HomeworkJdbc) context.getBean("HomeworkJdbc");
        StudentHomeworkJdbc StudentHomeworkJdbc = (org.example.spring.mvc.dao.StudentHomeworkJdbc) context.getBean("StudentHomeworkJdbc");
